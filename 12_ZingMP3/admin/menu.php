            ...
            <div class="navbar__content">
                ...
                <ul class="nav navbar__list flex-column">
                    <li class="nav-item navbar__item">
                        <a class="nav-link d-flex align-items-center navbar__link <?= $folder == 'root'?'active':''; if(empty($_GET['folder'])) {echo 'active';} ?>" href="../root?folder=root">
                            <i class="navbar__link-icon bi bi-speedometer2"></i>
                            <span>Dashboard</span> 
                        </a>
                    </li>
                    <li class="nav-item navbar__item">
                        <a class="nav-link d-flex align-items-center navbar__link <?= $folder == 'employees'?'active':'' ?>" href="../employees?folder=employees">
                            <i class="navbar__link-icon bi bi-person"></i>
                            <span>Nhân viên</span> 
                        </a>
                    </li>
                    <li class="nav-item navbar__item">
                        <a class="nav-link d-flex align-items-center navbar__link <?= $folder == 'users'?'active':'' ?>" href="../users?folder=users">
                            <i class="navbar__link-icon bi bi-person"></i>
                            <span>Người dùng</span> 
                        </a>
                    </li>
                    <li class="nav-item navbar__item">
                        <a class="nav-link d-flex align-items-center navbar__link <?= $folder == 'categories'?'active':'' ?>" href="../categories?folder=categories">
                            <i class="navbar__link-icon bi bi-slack"></i>
                            <span>Thể loại</span> 
                        </a>
                    </li>
                    <li class="nav-item navbar__item">
                        <a class="nav-link d-flex align-items-center navbar__link <?= $folder == 'songs' ? 'active' : '' ?>" href="../songs?folder=songs">
